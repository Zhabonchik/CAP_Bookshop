...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "authorsui/test/integration/FirstJourney",
    "authorsui/test/integration/AuthorsListJourney",
    "authorsui/test/integration/AuthorsObjectPageJourney",
    "authorsui/test/integration/BooksAuthorsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
