...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "booksauthorsui/test/integration/FirstJourney",
    "booksauthorsui/test/integration/BooksAuthorsListJourney",
    "booksauthorsui/test/integration/BooksAuthorsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
